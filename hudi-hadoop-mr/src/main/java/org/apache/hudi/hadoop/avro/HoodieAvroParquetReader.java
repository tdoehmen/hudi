...
/**
 * Use HoodieAvroParquetReader to support avro logical type.
 * It can support types that cannot be read by the default parquet reader, such as timestamp(long) and date(int)
 */
